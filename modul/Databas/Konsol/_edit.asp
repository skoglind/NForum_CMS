<% 
  cON_PAGE = "Hantera konsol - Konsoler - CMS"
%>
...
<!--#INCLUDE FILE="../../../_deftop.asp"-->
  ...
  ' #### LADDA IN DATA ####
    ...
    SQL = "SELECT * FROM cms_Konsol WHERE kID = " & CLng(lID)
    rsDB.Open SQL, Con
    ...
    Else                    ' EDITERAD POST
      ...
      cADD_ID                 = rsDB("kID")
      cADD_Konsol             = rsDB("kKonsol")
      cADD_Titel              = rsDB("kStandard_Titel")
      cADD_Text               = sEncode(rsDB("kTextM"))
      cADD_Nyckelord          = sEncode(rsDB("kNyckelord"))
      
      cADD_Synlig             = rsDB("kSynlig")
      
      cADD_StandardTitel      = rsDB("kStandard_Titel")
    End If
  ' ##################
  ...
  <div class="datablock rect morepadding">
    ...
    <div class="in_text"> <p>Skriv gärna in några nyckelord för att underlätta för sökning efter konsoler. Seprarera varje nyckelord med ett mellanslag.</p> </div>
      ...
      <div class="boxart_holder">
        <div class="boxart">
          ...
          <div class="controls">
            ...
            <input type="button" value="Ta bort" onclick="if(confirm('Vill du ta bort bilden?')){boxdeleteimg('mmID',1,'console');}" name="uplbtn">
          </div>
        ...
        <div class="boxart">
          ...
          <div class="controls">
            ...
            <input type="button" value="Ta bort" onclick="if(confirm('Vill du ta bort bilden?')){boxdeleteimg('mmID',2,'console');}" name="uplbtn">
          </div>
        ...
        <div class="boxart">
          ...
          <div class="controls">
            ...
            <input type="button" value="Ta bort" onclick="if(confirm('Vill du ta bort bilden?')){boxdeleteimg('mmID',3,'console');}" name="uplbtn">
          </div>
        ...
        <div class="boxart">
          ...
          <div class="controls">
            <input type="button" value="Välj..." style="font-weight: bold;" onclick="show_uploadbox('upload_valj_4_mmID','mmID',4,'Konsol',<% = cADD_ID %>)" id="upload_valj_4_mmID">
            <input type="button" value="Ta bort" onclick="if(confirm('Vill du ta bort bilden?')){boxdeleteimg('mmID',4,'console');}" name="uplbtn">
          </div>
          <div class="titel">Konsol</div>
        </div>
      </div>
  ...
  <script type="text/javascript">
    <%
      ...
      SQL = "SELECT * FROM cms_Konsoltitlar WHERE tKonsolID = " & CLng(listID) & " ORDER BY tID ASC"
      rsT.Open SQL, con
      ...
      Do Until rsT.EOF
        ...
        cADD_Kassett_no   = rsT("tBoxart_Konsol")
    ...
    <div class="holder">
      ...
      <div class="data">
        <form method="POST" enctype="multipart/form-data" id="boxart_upl">
          ...
          <input type="hidden" name="uArea" value="console">
  ...
  <div class="databox info">
    ...
    <div class="inner">
      ...
      If Not rsDB.EOF Then
        saveDate = Trim(CStr(rsDB("kDatumSparad") & " "))
