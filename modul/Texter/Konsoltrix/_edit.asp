<% 
  cON_PAGE = "Hantera tips & trix - Tips & Trix (Konsol) - CMS"
%>
...
<!--#INCLUDE FILE="../../../_deftop.asp"-->
  ...
  ' #### LADDA IN DATA ####
    ...
    SQL = "SELECT *, anvDB1.aNamn AS Anv1, anvDB2.aNamn AS Anv2 " & _
          ...
          "LEFT JOIN cms_Konsol ON kID = xKonsolID " & _
          "LEFT JOIN cms_KonsolTitlar ON tID = cms_Konsol.kStandard_Titel " & _
    ...
    If rsDB.EOF Then        ' NY POST
      ...
      cADD_ID                 = 0
      cADD_SpelID             = 0
      cADD_SpelText           = "Ingen konsol vald"
    Else                    ' EDITERAD POST
      lPBStatus = "EditPost"
      ...
      cADD_SpelID             = rsDB("xKonsolID")
      cADD_SpelText           = lstKonsolXShort(rsDB("kKonsol")) & " | " & rsDB("tTitel")
    End If
  ' ##################
  ...
  <div class="datablock rect morepadding">
    <div class="legend">Hantera tips & trix (Konsol)</div>
    ...
    <div class="in_row">
      ...
      <div class="input">
        ...
        <input type="button" class="browsebutton" value="Välj..." onclick="showPicker('/picker/cms_konsol.asp','sSpelID','sSpelText');">
        <input type="button" class="browsebutton" value="Ta bort" style="width: 65px; font-weight: normal;" onclick="clearPicker('sSpelID','sSpelText','Ingen konsol vald');">
