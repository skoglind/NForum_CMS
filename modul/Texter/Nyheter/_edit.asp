...
<!--#INCLUDE FILE="../../../_deftop.asp"-->
  ...
  <div class="datablock rect morepadding">
    ...
    <div class="in_row">
      <div class="text">Källa</div>
      <div class="input"><input type="text" class="fill" name="vKalla" maxlength="500" value="<% = cADD_Kalla %>"></div>
    </div>
    
    <div class="in_text"> <p>Du kan istället för att bara skriva namnet på sidan även ange en länk till källan. Skriv då enligt denna form <strong>Sidnamnet|www.sidnamnet.se</strong> där pipen (<strong>ALT GR + &gt;</strong>) separerar länken från namnet och du behöver inte ange <strong>http://</strong> då detta läggs till automatiskt. För att ange flera källor separera varje källa med <strong>;</strong> (semikolon).</p> </div>
    <div class="in_line"> </div>
    ...
    <div class="in_text"> <p>Skriv gärna in några nyckelord för att underlätta för sökning efter nyheter. Seprarera varje nyckelord med ett mellanslag.</p> </div>
  ...
  <div class="datablock rect morepadding">
    ...
    <div class="in_text"> <p>Detta fält är för fria noteringar som inte kommer synas för andra än de som kan redigera nyheten. Används även för att förklara varför en nyhet nekades publicering. Spara gärna alla käll-länkar i denna ruta.</p> </div>
  </div>
